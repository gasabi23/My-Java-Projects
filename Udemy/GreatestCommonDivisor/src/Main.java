...
public class Main {
   ...
   int getGreatestCommonDivisor = GreatestCommonDivisor.getGreatestCommonDivisor(25,15);
        System.out.println(getGreatestCommonDivisor);

        int getGreatestCommonDivisor2 = GreatestCommonDivisor.getGreatestCommonDivisor2(36,60);
        System.out.println(getGreatestCommonDivisor2);
    }
}
