...
in the course created the isLeapYear method. You can use that solution if you wish.
...
getDaysInMonth(1, -2020); → should return -1 since the parameter year
is outside the range of 1 to 9999.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boolean isLeapYear = NumberOfDaysInMonth2.isLeapYear(2000);
        System.out.println(isLeapYear);

        int getDaysInMonth = NumberOfDaysInMonth2.getDaysInMonth(-1,2020);
