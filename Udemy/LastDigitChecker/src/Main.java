...
The method needs to return true if the number parameter is in range of 10(inclusive) -
...
public class Main {
    ...
    boolean hasSameLastDigit = LastDigitChecker.hasSameLastDigit(9,99,999);
        System.out.println(hasSameLastDigit);

        boolean isValid = LastDigitChecker.isValid(156);
